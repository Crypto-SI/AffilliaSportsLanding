...
# This script converts Carl Anthony's image (carl.png) to WebP format

# Create directory if it doesn't exist (should already exist from previous conversions)
...
# Get source file
src_file="public/images/carl.png"
...
output_file="public/images/optimized/about/large/about-carl-portrait.webp"
...
output_file="public/images/optimized/about/medium/about-carl-portrait.webp"
...
output_file="public/images/optimized/about/small/about-carl-portrait.webp"
...
echo "Image conversion complete! Carl Anthony's portrait is now available in WebP format." 